 ...
 * Example ROM helpers.
 *
 * Each example variant ships a standalone `.msc` script in
 * `public/examples/` that is fetched at runtime.  The scripts are
 * self-contained — they include `Sprites:` with `$Grid`, entity
 * definitions, and an `Instances:` block for entity placement.
 */
