...
| Tool | Description |
|------|-------------|
| **New ROM** | Create a blank ROM or load an example project (Platformer, Top-Down, Particles) |
...
| [docs/USAGE_EXAMPLES.md](docs/USAGE_EXAMPLES.md) | Example ROMs with annotated scripts (Platformer, Top-Down, Particles) |
